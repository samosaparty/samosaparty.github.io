...
import { Wifi, Search, AlertCircle, Download, MapPin } from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-white p-8 rounded-2xl border" style={{ borderColor: 'var(--border)', boxShadow: '0 4px 20px -2px rgba(0, 0, 0, 0.03)' }}>
        <div>
          ...
          <p className="text-sm mt-2 font-medium" style={{ color: 'var(--text-muted)' }}>
            Primary and secondary Wi-Fi credentials for all outlets and locations.
          </p>
        </div>
        ...
        <div className="p-8 md:p-10 relative min-h-[400px]">
          ...
          {loading ? (
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-white/80 z-10 backdrop-blur-sm">
              ...
              <p className="text-slate-500 font-medium">Loading Wi-Fi directory...</p>
            </div>
          ) : null}
                  ...
                  <tr key={index} className="group" >
                    ...
                    <td>
                      <div className="flex flex-col gap-1.5">
                        ...
                        <div className="flex items-center gap-1.5 text-sm font-semibold" style={{ color: 'var(--text-muted)' }}>
                        ...
                        {row.wifi1Name && row.wifi1Name.toLowerCase() !== 'nill' ? (
                          <>
                            <div className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-lg inline-flex" style={{ border: '1px solid var(--border)' }}>
                              <span className="text-[0.75rem] font-bold uppercase tracking-wider" style={{ color: 'var(--text-muted)' }}>SSID</span>
                              <div className="w-[1px] h-3 bg-slate-200 mx-1"></div>
                              <span className="text-sm font-extrabold" style={{ color: 'var(--primary)' }}>{row.wifi1Name}</span>
                            </div>
                            <div className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-lg inline-flex" style={{ border: '1px solid var(--border)' }}>
                              <span className="text-[0.75rem] font-bold uppercase tracking-wider" style={{ color: 'var(--text-muted)' }}>PWD</span>
                              <div className="w-[1px] h-3 bg-slate-200 mx-1"></div>
                              <span className="text-sm font-mono font-bold px-1.5 py-0.5 rounded" style={{ backgroundColor: '#f0fdf4', color: '#16a34a', border: '1px solid #bbf7d0' }}>
                                {row.wifi1Pass}
                              </span>
                            </div>
                          </>
                        ) : (
                          <span className="text-[0.85rem] font-medium italic" style={{ color: 'var(--text-muted)' }}>No primary network</span>
                        )}
                      </div>
                    </td>
                        ...
                        {row.wifi2Name && row.wifi2Name.toLowerCase() !== 'nill' ? (
                          <>
                            <div className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-lg inline-flex" style={{ border: '1px solid var(--border)' }}>
                              <span className="text-[0.75rem] font-bold uppercase tracking-wider" style={{ color: 'var(--text-muted)' }}>SSID</span>
                              <div className="w-[1px] h-3 bg-slate-200 mx-1"></div>
                              <span className="text-sm font-extrabold" style={{ color: 'var(--text-main)' }}>{row.wifi2Name}</span>
                            </div>
                            <div className="flex items-center gap-2 bg-white px-3 py-1.5 rounded-lg inline-flex" style={{ border: '1px solid var(--border)' }}>
                              <span className="text-[0.75rem] font-bold uppercase tracking-wider" style={{ color: 'var(--text-muted)' }}>PWD</span>
                              <div className="w-[1px] h-3 bg-slate-200 mx-1"></div>
                          ...
                          <span className="text-[0.85rem] font-medium italic" style={{ color: 'var(--text-muted)' }}>No secondary network</span>
                        )}
                      </div>
                    </td>
                  </tr>
